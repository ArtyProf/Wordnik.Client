...
{
    /// <summary>
    /// Base class for random word and random words requests.
    /// Contains shared properties and query string generation logic.
    /// </summary>
    public abstract class RandomWordBaseRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Constructs the query string representation of the shared parameters.
        /// </summary>
        /// <returns>A query string to append to the API URL.</returns>
        protected virtual string GenerateBaseQueryString()
        {
